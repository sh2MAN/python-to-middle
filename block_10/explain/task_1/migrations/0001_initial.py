# Generated by Django 3.2.13 on 2022-09-05 03:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('number_pages',
                 models.SmallIntegerField(verbose_name='Количество страниц')),
                ('date_publication',
                 models.DateField(verbose_name='Дата публикации')),
                ('description', models.TextField(verbose_name='Описание')),
                ('author', models.ManyToManyField(related_name='books',
                                                  to='explain_task_1.Author',
                                                  verbose_name='Авторы')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=25,
                                          verbose_name='Наименование зала')),
                ('librarian', models.OneToOneField(null=True,
                                                   on_delete=django.db.models.deletion.SET_NULL,
                                                   to='explain_task_1.librarian',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                   to='explain_task_1.bookcard',
                                   verbose_name='Книга')),
                ('reader',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                   to='explain_task_1.reader',
                                   verbose_name='Читатель')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True,
                                           serialize=False, verbose_name='ID')),
                ('date_issue',
                 models.DateField(verbose_name='Дата выдачи книги')),
                ('date_return',
                 models.DateField(verbose_name='Дата возврата книги')),
                ('book',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                   to='explain_task_1.bookcard',
                                   verbose_name='Книга')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.PositiveSmallIntegerField(
                    choices=[('1', 'Доступна'), ('2', 'Отсутствует')],
                    default='1', verbose_name='Статус')),
                ('book',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                   to='explain_task_1.bookcard',
                                   verbose_name='Карточка')),
                ('hall', models.ForeignKey(null=True,
                                           on_delete=django.db.models.deletion.PROTECT,
                                           related_name='books',
                                           to='explain_task_1.libraryhall',
                                           verbose_name='Книжный зал')),
                ('rack', models.ForeignKey(null=True,
                                           on_delete=django.db.models.deletion.PROTECT,
                                           related_name='books',
                                           to='explain_task_1.rack',
                                           verbose_name='Номер полки')),
                ('shelf', models.ForeignKey(null=True,
                                            on_delete=django.db.models.deletion.PROTECT,
                                            related_name='books',
                                            to='explain_task_1.shelf',
                                            verbose_name='Номер стеллажа')),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(related_name='type_publications',
                                         to='explain_task_1.TypePublication',
                                         verbose_name='Тип издания'),
        ),
    ]
