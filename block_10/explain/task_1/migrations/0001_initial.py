# Generated by Django 3.2.13 on 2022-09-08 08:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_out_time', models.BooleanField(default=False, verbose_name='Книга возвращена не во время')),
                ('book', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='explain_task_1.bookcard', verbose_name='Книга')),
                ('reader', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ticket', to='explain_task_1.reader', verbose_name='Читатель')),
            ],
            options={
