# Generated by Django 3.2.13 on 2022-09-05 04:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='explain_task_1.bookcard', verbose_name='Карточка')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('number', models.PositiveSmallIntegerField(unique=True, verbose_name='Номер стеллажа')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('number', models.PositiveSmallIntegerField(unique=True, verbose_name='Номер полки')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='explain_task_1.bookinstance', verbose_name='Книга')),
        ...
        migrations.AddField(
            ...
            name='hall',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='books', to='explain_task_1.libraryhall', verbose_name='Книжный зал'),
        ),
        migrations.AddField(
            model_name='bookinstance',
            name='rack',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='books', to='explain_task_1.rack', verbose_name='Номер полки'),
        ),
        migrations.AddField(
            model_name='bookinstance',
            name='shelf',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='books', to='explain_task_1.shelf', verbose_name='Номер стеллажа'),
        ),
        migrations.AddField(
            model_name='bookcard',
